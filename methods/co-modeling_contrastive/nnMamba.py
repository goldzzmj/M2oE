...
class nnMamba(nn.Module):
    def __init__(self, in_ch=3, channels=32, blocks=3, number_classes=3):
...
if __name__ == '__main__':
    block = nnMamba().cuda()
    input = torch.rand(8, 3, 128, 128, 128).cuda() # （8, 3, 128, 128, 128）
    output = block(input) # （8, 3, 128, 128, 128）
    print(input.size())
    print(output.size())
